...
import { CalendarDays, SearchIcon, Ticket } from "lucide-react";
    ...
    <>
      ...
      {events.length === 0 && (
        <div className="text-center py-12 bg-white rounded-xl shadow-sm">
          ...
          <p>Search some other event by name or location.</p>
        </div>
      )}

      <div className="flex mt-4 items-center justify-between mb-8">
        <div>
          <h1 className="font-bold text-3xl text-gray-900">Upcoming Events</h1>
